# -*- coding: utf-8 -*-
"""
DeepMIMOv3_noPL Python Implementation
...
import DeepMIMOv3_noPL.consts as c
from DeepMIMOv3_noPL.construct_deepmimo import generate_MIMO_channel, generate_MIMO_channel_rx_ind
from DeepMIMOv3_noPL.utils import safe_print
...
def validate_params(params):
    ...
    if params['data_version'] == 'v2':
        from DeepMIMOv3_noPL.raytracing_v2 import load_scenario_params, read_raytracing
    elif params['data_version'] == 'v3':
        from DeepMIMOv3_noPL.raytracing_v3 import load_scenario_params, read_raytracing
